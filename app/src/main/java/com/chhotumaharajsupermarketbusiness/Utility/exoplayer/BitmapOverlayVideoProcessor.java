 ...
 */
package com.chhotumaharajsupermarketbusiness.Utility.exoplayer;
...
/* package */ public final class BitmapOverlayVideoProcessor
  ...
  public BitmapOverlayVideoProcessor(Context context) {
    ...
    try {
      logoBitmap =getBitmapFromDrawable(context.getApplicationInfo().loadIcon(context.getPackageManager()));
          /*((BitmapDrawable)
  ...
  public void draw(int frameTexture, long frameTimestampUs) {
    ...
    GLUtils.texSubImage2D(
        GL10.GL_TEXTURE_2D, *//* level= *//* 0, *//* xoffset= *//* 0, *//* yoffset= *//* 0, null);*/
    GlUtil.checkGlError();
